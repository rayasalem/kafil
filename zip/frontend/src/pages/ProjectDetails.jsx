...
import MoneyFlowBar from '../components/MoneyFlowBar.jsx';
...
export default function ProjectDetails() {
  ...
  const user = JSON.parse(localStorage.getItem('user')) || { role: 'client' };

  const loadProject = () => api.getProject(id).then(setProject).catch(console.error);
