...
export default function ClientDashboard() {
  ...
  const user: User = JSON.parse(localStorage.getItem('user') || 'null') || { role: 'client', username: 'ahmed_k', name: 'Ahmed Khaled', id: '1' };
  ...
  return (
    <div className="animate-fade-in max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-1">الخزنة المركزية</h1>
      ...
      <div className="grid md:grid-cols-3 gap-5 mb-12">
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] flex flex-col justify-between h-36 relative overflow-hidden">
          ...
          <p className="text-sm font-bold text-gray-400 uppercase flex items-center gap-2"><Briefcase size={16}/> إجمالي ميزانياتك</p>
      ...
      <div className="mb-12 bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
         <h2 className="text-xl font-black text-gray-900 mb-6 flex items-center gap-2"><Wallet className="text-blue-600"/> مسار ميزانيتك</h2>
         <div className="flex flex-col md:flex-row items-center justify-between max-w-3xl mx-auto relative gap-4">
            ...
            <div className="bg-emerald-50 border border-emerald-200 w-32 p-4 rounded-2xl text-center z-10">
              ...
              <span className="text-xs font-bold text-emerald-600">مصروفة للمستقلين</span>
            </div>
         </div>
      </div>
